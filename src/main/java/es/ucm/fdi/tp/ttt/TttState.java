 ...
 * TABLERO COMO MATRIZ
 * EMPTY
 * UN BOOL PARA SABER SI ESTÁ FINALIZADO
 */
...
/*
 * EN EL TT SE IDENTIFICAN LAS POSICIONES VÁLIDAS VIENDO LAS VACIAS
 * NO HAY OVEJAS, HAY MOVIMIENTOS!
 * ENUMERADO CON LOS MOVIMIENTOS COMO CLASE Y UN MÉTODO QUE NOS DIGA SI SE SALE
 */
...
/*
 * cÓMO SABER SI EL LOBO ES UN JUGADOR
 * SI LA FILA 0 EN ALGUNA DE LAS COLUMNAS ESTÁ EL LOBO
 * EL LOBO NO TIENE MOVIMIENTOS -> GANAN LAS OVEJAS
 * NO HAY TABLAS
 * COMPROBAR QUE SE PUEDAN HACER MOVIMINETOS DE MAS DE UNA CASILLA
 */
